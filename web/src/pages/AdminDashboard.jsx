            ...
            <main className="flex-1 p-8 overflow-y-auto">
                <header className="flex justify-between items-center mb-10">
                    <div>
                        ...
                        <p className="text-text-muted mt-1 uppercase text-[10px] font-bold tracking-widest px-2 py-0.5 bg-surface border border-border rounded-full inline-block">Registrar Control Panel</p>
                    </div>
